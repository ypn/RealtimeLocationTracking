...
<body>
  ...
  <div style="position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.7);"></div>
   <div class="login" id="root-react"></div>
...
function go() {
  ...
  <script src='/js/login/login-bundle.js'></script>
</body>
